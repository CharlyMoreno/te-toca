...
export type Occurrence = {
  id: string; task_id: string; title: string; room: RoomId; icon: string; pet_id: string | null;
...
export type Routine = { id: string; title: string; room: RoomId; pet_id: string | null; active: number; frequency: string }
