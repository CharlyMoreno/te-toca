export const roomKinds = ['kitchen','bathroom','bedroom','living','garage','garden'] as const
export const initialRoomKinds = ['kitchen','bathroom','bedroom','living'] as const
...
export const roomCatalog: Record<RoomKind,{name:string;color:string;floor:string;icon:string;suggestion:string}> = {
  ...
  garage:{name:'Garaje',color:'#8695a5',floor:'#a8aaa5',icon:'clean',suggestion:'Ordenar el garaje'},
  garden:{name:'Jardín',color:'#83a86d',floor:'#7c9c61',icon:'clean',suggestion:'Regar las plantas'},
}
